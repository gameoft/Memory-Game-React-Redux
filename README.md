...
2. **Clone this repository.** - `git clone https://github.com/gameoft/memory-game-react.git` or [download the zip](https://github.com/gameoft/memory-game-react/archive/master.zip)
